...
import {
  ...
  useQuery,
  useSuspenseQuery
} from "./chunk-G4QP5P4S.js";
import "./chunk-XKE54C7U.js";
import {
  require_jsx_runtime
} from "./chunk-4G7V6IWP.js";
import {
  require_react
...
import {
  Ed25519Keypair,
  graphql
} from "./chunk-VVYRV6HM.js";
import {
  SuiClient,
  getFullnodeUrl,
  isSuiClient
} from "./chunk-B3UEPYRO.js";
import {
  Transaction,
  literal,
  object,
...
var require_use_sync_external_store_shim_development = __commonJS({
  "node_modules/.pnpm/use-sync-external-store@1.5.0_react@19.1.0/node_modules/use-sync-external-store/cjs/use-sync-external-store-shim.development.js"(exports) {
    ...
    (function() {
      ...
      var React = require_react(), objectIs = "function" === typeof Object.is ? Object.is : is, useState5 = React.useState, useEffect5 = React.useEffect, useLayoutEffect3 = React.useLayoutEffect, useDebugValue2 = React.useDebugValue, didWarnOld18Alpha = false, didWarnUncachedGetSnapshot = false, shim = "undefined" === typeof window || "undefined" === typeof window.document || "undefined" === typeof window.document.createElement ? useSyncExternalStore$1 : useSyncExternalStore$2;
...
// node_modules/.pnpm/use-sync-external-store@1.5.0_react@19.1.0/node_modules/use-sync-external-store/cjs/use-sync-external-store-shim/with-selector.development.js
var require_with_selector_development = __commonJS({
  "node_modules/.pnpm/use-sync-external-store@1.5.0_react@19.1.0/node_modules/use-sync-external-store/cjs/use-sync-external-store-shim/with-selector.development.js"(exports) {
    "use strict";
    (function() {
      function is(x, y) {
        return x === y && (0 !== x || 1 / x === 1 / y) || x !== x && y !== y;
      ...
      "undefined" !== typeof __REACT_DEVTOOLS_GLOBAL_HOOK__ && "function" === typeof __REACT_DEVTOOLS_GLOBAL_HOOK__.registerInternalModuleStart && __REACT_DEVTOOLS_GLOBAL_HOOK__.registerInternalModuleStart(Error());
      var React = require_react(), shim = require_shim(), objectIs = "function" === typeof Object.is ? Object.is : is, useSyncExternalStore = shim.useSyncExternalStore, useRef2 = React.useRef, useEffect5 = React.useEffect, useMemo3 = React.useMemo, useDebugValue2 = React.useDebugValue;
...
var require_with_selector = __commonJS({
  "node_modules/.pnpm/use-sync-external-store@1.5.0_react@19.1.0/node_modules/use-sync-external-store/shim/with-selector.js"(exports, module) {
    "use strict";
    if (false) {
      module.exports = null;
    } else {
...
// node_modules/.pnpm/@mysten+dapp-kit@0.15.2_@tanstack+react-query@5.71.10_react@19.1.0__@types+react-dom@19_c5ae9673988f3355e76c78c78ad1252f/node_modules/@mysten/dapp-kit/dist/esm/index.js
var import_react2 = __toESM(require_react());

// node_modules/.pnpm/@mysten+zksend@0.12.22_typescript@5.8.2/node_modules/@mysten/zksend/dist/esm/links/zk-bag.js
var _package;
var _module;
_package = /* @__PURE__ */ new WeakMap();
_module = /* @__PURE__ */ new WeakMap();

// node_modules/.pnpm/@mysten+zksend@0.12.22_typescript@5.8.2/node_modules/@mysten/zksend/dist/esm/links/builder.js
var __typeError = (msg) => {
  throw TypeError(msg);
};
...
objectsToTransfer_fn = async function(tx) {
  ...
  const refsWithType = this.objectRefs.concat(
    (objectIDs.length > 0 ? await __privateGet2(this, _client).multiGetObjects({
      ids: objectIDs,
      options: {
        showType: true
      }
      ...
      if (!res.data || res.error) {
        throw new Error(`Failed to load object ${objectIDs[i]} (${(_a3 = res.error) == null ? void 0 : _a3.code})`);
      }
      return {
        ref: tx.objectRef({
  ...
  for (const [coinType, amount] of this.balances) {
    if (coinType === SUI_COIN_TYPE) {
      ...
      const coins = (await __privateMethod2(this, _ZkSendLinkBuilder_instances, getCoinsByType_fn).call(this, coinType)).map((coin) => coin.coinObjectId);
      if (coins.length > 1) {
...
createSendTransactionWithoutContract_fn = async function({
  ...
  const gasEstimateFromDryRun = await __privateMethod2(this, _ZkSendLinkBuilder_instances, estimateClaimGasFee_fn).call(this);
  ...
  const objectsToTransfer = (await __privateMethod2(this, _ZkSendLinkBuilder_instances, objectsToTransfer_fn).call(this, tx)).map((obj) => obj.ref);
...
estimateClaimGasFee_fn = async function() {
  ...
  for (const [coinType] of this.balances) {
    const coins = await __privateMethod2(this, _ZkSendLinkBuilder_instances, getCoinsByType_fn).call(this, coinType);
    if (!coins.length) {
  ...
  const result = await __privateGet2(this, _client).dryRunTransactionBlock({
    transactionBlock: await tx.build({ client: __privateGet2(this, _client) })
  });
...
getCoinsByType_fn = async function(coinType) {
  if (__privateGet2(this, _coinsByType).has(coinType)) {
    return __privateGet2(this, _coinsByType).get(coinType);
  }
  const coins = await __privateGet2(this, _client).getCoins({
    coinType,
    owner: this.sender
  });
  __privateGet2(this, _coinsByType).set(coinType, coins.data);
  return coins.data;
};

// node_modules/.pnpm/@mysten+zksend@0.12.22_typescript@5.8.2/node_modules/@mysten/zksend/dist/esm/links/utils.js
function getAssetsFromTransaction({
  ...
  const nfts = [];
  const coins = [];
  (_a3 = transaction.balanceChanges) == null ? void 0 : _a3.forEach((change) => {
  ...
  (_b2 = transaction.objectChanges) == null ? void 0 : _b2.forEach((change) => {
...
// node_modules/.pnpm/@mysten+zksend@0.12.22_typescript@5.8.2/node_modules/@mysten/zksend/dist/esm/links/claim.js
...
loadBagObject_fn = async function() {
  if (!__privateGet3(this, _contract2)) {
    throw new Error("Cannot load bag object for non-contract based links");
  }
  const bagField = await __privateGet3(this, _client2).getDynamicFieldObject({
    parentId: __privateGet3(this, _contract2).ids.bagStoreTableId,
    name: {
      type: "address",
      value: this.address
    }
...
loadBag_fn = async function({
  ...
  if (!this.bagObject || !this.claimed) {
    await __privateMethod3(this, _ZkSendLink_instances, loadBagObject_fn).call(this);
  }
  if (!loadAssets) {
    return;
  }
  if (!this.bagObject) {
    if (loadClaimedAssets) {
      await __privateMethod3(this, _ZkSendLink_instances, loadClaimedAssets_fn).call(this);
    }
    return;
  }
  ...
  const objectsResponse = await __privateGet3(this, _client2).multiGetObjects({
    ids: itemIds,
    options: {
      showType: true,
      showContent: true
  ...
  objectsResponse.forEach((object2, i) => {
    var _a4;
    if (!object2.data || !object2.data.type) {
      throw new Error(`Failed to load claimable object ${itemIds[i]}`);
    }
    const type = parseStructTag(normalizeStructTag(object2.data.type));
    if (type.address === normalizeSuiAddress("0x2") && type.module === "coin" && type.name === "Coin") {
      ...
      if (((_a4 = object2.data.content) == null ? void 0 : _a4.dataType) === "moveObject") {
...
loadClaimedAssets_fn = async function() {
  var _a3;
  const result = await __privateGet3(this, _client2).queryTransactionBlocks({
    limit: 1,
    filter: {
  ...
  if (((_a3 = tx.transaction) == null ? void 0 : _a3.data.transaction.kind) !== "ProgrammableTransaction") {
    return;
  }
...
createSponsoredTransaction_fn = async function(tx, claimer, sender) {
  return __privateMethod3(this, _ZkSendLink_instances, fetch_fn).call(this, "transaction-blocks/sponsor", {
    method: "POST",
    body: JSON.stringify({
      network: __privateGet3(this, _network),
      sender,
      claimer,
      transactionBlockKindBytes: toBase64(
        await tx.build({
          onlyTransactionKind: true,
          client: __privateGet3(this, _client2)
        })
      )
    })
  });
...
executeSponsoredTransaction_fn = async function(input, signature) {
  return __privateMethod3(this, _ZkSendLink_instances, fetch_fn).call(this, `transaction-blocks/sponsor/${input.digest}`, {
    method: "POST",
    body: JSON.stringify({
      signature
    })
...
fetch_fn = async function(path, init) {
  const res = await fetch(`${__privateGet3(this, _claimApi)}/v1/${path}`, {
    ...init,
    headers: {
      ...init.headers,
...
listNonContractClaimableAssets_fn = async function() {
  ...
  const nfts = [];
  const coins = [];
  if (__privateGet3(this, _ownedObjects).length === 0 && !__privateGet3(this, _hasSui)) {
    return {
      balances,
      nfts,
      coins
  ...
  if (__privateGet3(this, _gasCoin) || !__privateGet3(this, _hasSui)) {
    tx.setGasPayment([]);
  }
  const dryRun = await __privateGet3(this, _client2).dryRunTransactionBlock({
...
createNonContractClaimTransaction_fn = function(address) {
  ...
  const objectsToTransfer = __privateGet3(this, _ownedObjects).filter((object2) => {
    if (__privateGet3(this, _gasCoin)) {
      if (object2.objectId === __privateGet3(this, _gasCoin).coinObjectId) {
        return false;
      }
  ...
  if (__privateGet3(this, _gasCoin) && this.creatorAddress) {
...
loadOwnedObjects_fn = async function({
  ...
  let nextCursor;
  do {
    const ownedObjects = await __privateGet3(this, _client2).getOwnedObjects({
      cursor: nextCursor,
      owner: this.address,
      options: {
        showType: true,
    ...
    for (const object2 of ownedObjects.data) {
      if (object2.data) {
        __privateGet3(this, _ownedObjects).push({
  ...
  __privateSet2(this, _hasSui, coins.data.length > 0);
  __privateSet2(this, _gasCoin, coins.data.find((coin) => BigInt(coin.balance) % 1000n === 987n));
  const result = await __privateGet3(this, _client2).queryTransactionBlocks({
    limit: 1,
    order: "ascending",
    filter: {
  ...
  if (__privateGet3(this, _hasSui) || __privateGet3(this, _ownedObjects).length > 0) {
    this.claimed = false;
    this.assets = await __privateMethod3(this, _ZkSendLink_instances, listNonContractClaimableAssets_fn).call(this);
...
// node_modules/.pnpm/@mysten+zksend@0.12.22_typescript@5.8.2/node_modules/@mysten/zksend/dist/esm/links/list-created-links.js
var ListCreatedLinksQuery = graphql(`
...
// node_modules/.pnpm/@wallet-standard+errors@0.1.0/node_modules/@wallet-standard/errors/lib/esm/codes.js
...
// node_modules/.pnpm/@wallet-standard+errors@0.1.0/node_modules/@wallet-standard/errors/lib/esm/messages.js
...
// node_modules/.pnpm/@wallet-standard+errors@0.1.0/node_modules/@wallet-standard/errors/lib/esm/message-formatter.js
var StateType;
(function(StateType2) {
...
// node_modules/.pnpm/@mysten+wallet-standard@0.14.2_typescript@5.8.2/node_modules/@mysten/wallet-standard/dist/esm/wallet.js
...
// node_modules/.pnpm/@mysten+wallet-standard@0.14.2_typescript@5.8.2/node_modules/@mysten/wallet-standard/dist/esm/detect.js
...
// node_modules/.pnpm/@mysten+wallet-standard@0.14.2_typescript@5.8.2/node_modules/@mysten/wallet-standard/dist/esm/chains.js
...
// node_modules/.pnpm/@mysten+zksend@0.12.22_typescript@5.8.2/node_modules/@mysten/zksend/dist/esm/utils/withResolvers.js
...
// node_modules/.pnpm/@mysten+zksend@0.12.22_typescript@5.8.2/node_modules/@mysten/zksend/dist/esm/wallet/channel/events.js
...
// node_modules/.pnpm/@mysten+zksend@0.12.22_typescript@5.8.2/node_modules/@mysten/zksend/dist/esm/wallet/channel/index.js
...
var __privateAdd2 = (obj, member, value) => member.has(obj) ? __typeError3("Cannot add the same private member more than once") : member instanceof WeakSet ? member.add(obj) : member.set(obj, value);
...
var __privateMethod4 = (obj, member, method) => (__accessCheck3(obj, member, "access private method"), method);
var _popup;
var _id;
var _origin;
var _name;
...
var StashedPopup = class {
  constructor({
    ...
    __privateAdd2(this, _StashedPopup_instances);
    __privateAdd2(this, _popup);
    __privateAdd2(this, _id);
    __privateAdd2(this, _origin);
    __privateAdd2(this, _name);
    __privateAdd2(this, _network2);
    __privateAdd2(this, _promise);
    __privateAdd2(this, _resolve);
    __privateAdd2(this, _reject);
    __privateAdd2(this, _interval, null);
    __privateAdd2(this, _listener, (event) => {
      if (event.origin !== __privateGet4(this, _origin)) {
        return;
      }
      const { success, output } = safeParse(StashedResponse, event.data);
      if (!success || output.id !== __privateGet4(this, _id)) return;
      __privateMethod4(this, _StashedPopup_instances, cleanup_fn).call(this);
      if (output.payload.type === "reject") {
        __privateGet4(this, _reject).call(this, new Error("User rejected the request"));
      } else if (output.payload.type === "resolve") {
        __privateGet4(this, _resolve).call(this, output.payload.data);
      }
    });
    ...
    __privateSet3(this, _popup, popup);
    __privateSet3(this, _id, crypto.randomUUID());
    __privateSet3(this, _origin, origin);
    __privateSet3(this, _name, name);
    __privateSet3(this, _network2, network);
    const { promise, resolve, reject } = withResolvers();
    __privateSet3(this, _promise, promise);
    __privateSet3(this, _resolve, resolve);
    __privateSet3(this, _reject, reject);
    __privateSet3(this, _interval, setInterval(() => {
      try {
        if (__privateGet4(this, _popup).closed) {
          __privateMethod4(this, _StashedPopup_instances, cleanup_fn).call(this);
  ...
  send({
    ...
    window.addEventListener("message", __privateGet4(this, _listener));
    __privateGet4(this, _popup).location.assign(
      `${__privateGet4(this, _origin)}/dapp/${type}?${new URLSearchParams({
        id: __privateGet4(this, _id),
        origin: window.origin,
        network: __privateGet4(this, _network2),
        name: __privateGet4(this, _name)
      })}${data ? `#${new URLSearchParams(data)}` : ""}`
    );
    return __privateGet4(this, _promise);
  }
  close() {
    __privateMethod4(this, _StashedPopup_instances, cleanup_fn).call(this);
    __privateGet4(this, _popup).close();
  }
};
...
cleanup_fn = function() {
  if (__privateGet4(this, _interval)) {
    clearInterval(__privateGet4(this, _interval));
    __privateSet3(this, _interval, null);
  }
  window.removeEventListener("message", __privateGet4(this, _listener));
};
_request = /* @__PURE__ */ new WeakMap();

// node_modules/.pnpm/@mysten+zksend@0.12.22_typescript@5.8.2/node_modules/@mysten/zksend/dist/esm/wallet/index.js
...
var __privateAdd3 = (obj, member, value) => member.has(obj) ? __typeError4("Cannot add the same private member more than once") : member instanceof WeakSet ? member.add(obj) : member.set(obj, value);
...
var __privateMethod5 = (obj, member, method) => (__accessCheck4(obj, member, "access private method"), method);
var _events;
var _accounts;
var _origin2;
var _name2;
...
var StashedWallet = class {
  constructor({
    ...
    __privateAdd3(this, _StashedWallet_instances);
    __privateAdd3(this, _events);
    __privateAdd3(this, _accounts);
    __privateAdd3(this, _origin2);
    __privateAdd3(this, _name2);
    __privateAdd3(this, _network3);
    __privateAdd3(this, _signTransactionBlock, async ({ transactionBlock, account }) => {
      transactionBlock.setSenderIfNotSet(account.address);
      const data = transactionBlock.serialize();
      const popup = new StashedPopup({
        name: __privateGet5(this, _name2),
        origin: __privateGet5(this, _origin2),
        network: __privateGet5(this, _network3)
      });
    ...
    __privateAdd3(this, _signTransaction, async ({ transaction, account }) => {
      const popup = new StashedPopup({
        name: __privateGet5(this, _name2),
        origin: __privateGet5(this, _origin2),
        network: __privateGet5(this, _network3)
    ...
    __privateAdd3(this, _signPersonalMessage, async ({ message, account }) => {
      const popup = new StashedPopup({
        name: __privateGet5(this, _name2),
        origin: __privateGet5(this, _origin2),
        network: __privateGet5(this, _network3)
    ...
    __privateAdd3(this, _on, (event, listener) => {
      __privateGet5(this, _events).on(event, listener);
      return () => __privateGet5(this, _events).off(event, listener);
    });
    __privateAdd3(this, _connect, async (input) => {
      if (input == null ? void 0 : input.silent) {
        const address2 = localStorage.getItem(STASHED_RECENT_ADDRESS_KEY);
        if (address2) {
          __privateMethod5(this, _StashedWallet_instances, setAccount_fn).call(this, address2);
        }
      ...
      __privateMethod5(this, _StashedWallet_instances, setAccount_fn).call(this, response.address);
      return { accounts: this.accounts };
    });
    __privateAdd3(this, _disconnect, async () => {
      localStorage.removeItem(STASHED_RECENT_ADDRESS_KEY);
      __privateMethod5(this, _StashedWallet_instances, setAccount_fn).call(this);
    });
    __privateSet4(this, _accounts, []);
    __privateSet4(this, _events, mitt_default());
    __privateSet4(this, _origin2, origin);
    __privateSet4(this, _name2, name);
    __privateSet4(this, _network3, network);
    if (address) {
      __privateMethod5(this, _StashedWallet_instances, setAccount_fn).call(this, address);
    }
  }
  get name() {
  ...
  get chains() {
    return [`sui:${__privateGet5(this, _network3)}`];
  }
  get accounts() {
    return __privateGet5(this, _accounts);
  }
  get features() {
    return {
      "standard:connect": {
      ...
      "standard:disconnect": {
        version: "1.0.0",
        disconnect: __privateGet5(this, _disconnect)
      },
      "standard:events": {
        version: "1.0.0",
      ...
      "sui:signTransaction": {
        version: "2.0.0",
        signTransaction: __privateGet5(this, _signTransaction)
      },
...
setAccount_fn = function(address) {
  ...
  __privateGet5(this, _events).emit("change", { accounts: this.accounts });
};
...
// node_modules/.pnpm/zustand@4.5.6_@types+react@19.1.0_react@19.1.0/node_modules/zustand/esm/vanilla.mjs
...
// node_modules/.pnpm/zustand@4.5.6_@types+react@19.1.0_react@19.1.0/node_modules/zustand/esm/index.mjs
...
// node_modules/.pnpm/@vanilla-extract+recipes@0.5.5_@vanilla-extract+css@1.17.1/node_modules/@vanilla-extract/recipes/dist/createRuntimeFn-62c9670f.esm.js
...
// node_modules/.pnpm/zustand@4.5.6_@types+react@19.1.0_react@19.1.0/node_modules/zustand/esm/middleware.mjs
...
var __privateAdd4 = (obj, member, value) => member.has(obj) ? __typeError5("Cannot add the same private member more than once") : member instanceof WeakSet ? member.add(obj) : member.set(obj, value);
...
function ConnectionStatus({
  ...
  return (0, import_jsx_runtime8.jsxs)("div", { className: container2, children: [
    selectedWallet.icon && (0, import_jsx_runtime8.jsx)(
      "img",
      {
...
function WalletListItem({ name, icon, onClick, isSelected = false }) {
  return (0, import_jsx_runtime13.jsx)("li", { className: container7, children: (0, import_jsx_runtime13.jsxs)(
    "button",
    {
      ...
      onClick,
      children: [
        icon && typeof icon === "string" ? (0, import_jsx_runtime13.jsx)("img", { className: walletIcon2, src: icon, alt: `${name} logo` }) : icon,
...
function ConnectModal({
  ...
  const wallets2 = useWallets().filter(walletFilter);
...
var SuiClientContext = (0, import_react12.createContext)(null);
...
function SuiClientProvider(props) {
  ...
  const [selectedNetwork, setSelectedNetwork] = (0, import_react12.useState)(
...
function useSuiClientContext() {
  const suiClient = (0, import_react11.useContext)(SuiClientContext);
  if (!suiClient) {
    throw new Error(
...
function useSuiClientSuspenseQuery(...args) {
  ...
  const suiContext = useSuiClientContext();
  const query = (0, import_react10.useMemo)(() => {
...
function useAutoConnectWallet() {
  ...
  const [clientOnly, setClientOnly] = (0, import_react14.useState)(false);
...
function useStashedWallet(config) {
  ...
  (0, import_react15.useLayoutEffect)(() => {
    ...
    return unregister;
  }, [config == null ? void 0 : config.name, config == null ? void 0 : config.origin, config == null ? void 0 : config.network]);
}
...
function registerUnsafeBurnerWallet(suiClient) {
  ...
  class UnsafeBurnerWallet {
    constructor() {
      __privateAdd4(this, _on2, () => {
        return () => {
        };
      });
      __privateAdd4(this, _connect2, async () => {
        return { accounts: this.accounts };
      });
      __privateAdd4(this, _signPersonalMessage2, async (messageInput) => {
        const { bytes, signature } = await keypair.signPersonalMessage(messageInput.message);
        return { bytes, signature };
      });
      __privateAdd4(this, _signTransactionBlock2, async (transactionInput) => {
      ...
      __privateAdd4(this, _signTransaction2, async (transactionInput) => {
        var _a3;
        ...
        (_a3 = transactionInput.signal) == null ? void 0 : _a3.throwIfAborted();
        return {
          bytes,
          signature
        };
      });
      __privateAdd4(this, _signAndExecuteTransactionBlock, async (transactionInput) => {
        const { bytes, signature } = await transactionInput.transactionBlock.sign({
          client: suiClient,
          signer: keypair
        });
      ...
      __privateAdd4(this, _signAndExecuteTransaction, async (transactionInput) => {
        var _a3;
        const { bytes, signature } = await Transaction.from(
          await transactionInput.transaction.toJSON()
        ).sign({
    ...
    get features() {
      return {
        "standard:connect": {
          version: "1.0.0",
          connect: __privateGet6(this, _connect2)
        },
        "standard:events": {
          version: "1.0.0",
          on: __privateGet6(this, _on2)
        },
        "sui:signPersonalMessage": {
          version: "1.1.0",
          signPersonalMessage: __privateGet6(this, _signPersonalMessage2)
        },
        "sui:signTransactionBlock": {
          version: "1.0.0",
          signTransactionBlock: __privateGet6(this, _signTransactionBlock2)
        },
        "sui:signAndExecuteTransactionBlock": {
          version: "1.0.0",
          signAndExecuteTransactionBlock: __privateGet6(this, _signAndExecuteTransactionBlock)
        },
        "sui:signTransaction": {
          version: "2.0.0",
          signTransaction: __privateGet6(this, _signTransaction2)
        },
        "sui:signAndExecuteTransaction": {
          version: "2.0.0",
...
function WalletProvider({
  ...
  const storeRef = (0, import_react13.useRef)(
    createWalletStore({
...
function useReportTransactionEffects({
  ...
  return useMutation({
    ...
    mutationFn: async ({ effects, chain = currentWallet == null ? void 0 : currentWallet.chains[0], account = currentAccount }) => {
      if (!currentWallet) {
        throw new WalletNotConnectedError("No wallet is connected.");
      }
      if (!account) {
      ...
      if (reportTransactionEffectsFeature) {
        return await reportTransactionEffectsFeature.reportTransactionEffects({
          ...
          account,
          chain: chain ?? (currentWallet == null ? void 0 : currentWallet.chains[0])
        });
      }
    },
    ...mutationOptions
...
function useSignAndExecuteTransaction({
  ...
  return useMutation({
    ...
    mutationFn: async ({ transaction, ...signTransactionArgs }) => {
      ...
      let effects;
      if ("effects" in result && ((_a3 = result.effects) == null ? void 0 : _a3.bcs)) {
